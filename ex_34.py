#
# Example showing which times and operators were responsible for wave function
# collapse in the monte-carlo simulation of a dissipative trilinear
# Hamiltonian.
#
from qutip import *
from pylab import *
...
def run():
    ...
    ax.set_xlabel('Trajectory', fontsize=16)
    ax.set_ylabel('Collpase Time', fontsize=16)
    ax.set_title(r'Blue = $C_{0}$, Red = $C_{1}$, Green= $C_{2}$')
    show()
