...
class Bloch:
    ...
    def add_latitude(self, init_pt, fin_pt):
        # connects two points with an arc on a same latitude.
        # Inputs have to be in spherical coordinates.
    ...
    def add_longitude(self, init_pt, fin_pt):
        # connects two points with an arc on a same longitude.
        # Inputs have to be in spherical coordinates.
        # Used in the function add_arc
        r = init_pt[0]
    ...
    def add_arc(self, init_pt, fin_pt):
        ...
        ----------
        init_pt : array_like
            Array with cartesian coordinates of initial point on Bloch sphere

        fin_pt : array_like
            Array with cartesian coordinates of final point on Bloch sphere
        """
