...
Exception classes for Quantum Control library
"""

class Error(Exception):
    """Base class for all optquantctl exceptions"""
...
class OptimisationTerminate(Error):
    """
    Superclass for all early terminations from the optimisation algorithm
    """
    pass

class GoalAchievedTerminate(OptimisationTerminate):
    """
...
class MaxWallTimeTerminate(OptimisationTerminate):
    """
...
class GradMinReachedTerminate(OptimisationTerminate):
    """
