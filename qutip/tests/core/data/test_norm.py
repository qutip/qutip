...
class TestOneNorm(testing.UnaryOpMixin):
    ...
    specialisations = [
        ...
        pytest.param(data.norm.one_diag, Diag, numbers.Number),
...
class TestFrobeniusNorm(testing.UnaryOpMixin):
    ...
    specialisations = [
        ...
        pytest.param(data.norm.frobenius_diag, Diag, numbers.Number),
...
class TestMaxNorm(testing.UnaryOpMixin):
    ...
    specialisations = [
        ...
        pytest.param(data.norm.max_diag, Diag, numbers.Number),
...
class TestL2Norm(testing.UnaryOpMixin):
    ...
    specialisations = [
        ...
        pytest.param(data.norm.l2_diag, Diag, numbers.Number),
