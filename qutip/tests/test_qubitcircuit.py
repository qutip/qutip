...
class TestQubitCircuit:
    ...
    def test_resolve(self, gate_from, gate_to, targets, controls):
        qc1 = QubitCircuit(2)
    ...
    def test_user_gate(self):
        ...
        result1 = tensor(qeye(2), customer_gate1(np.pi/2))
        np.testing.assert_allclose(props[0].full(), result1.full())
        result2 = tensor(qeye(2), customer_gate2(), qeye(2))
