    ...
    def __mul__(self, other):
        ...
        if isinstance(other, Qobj):  # if both are quantum objects
            if (self.shape[1] == other.shape[0] and
                ...
                out = Qobj()
                out.data = self.data * other.data
                out.dims = [max([1], [d for d in self.dims[0]  if d != 1]),
                            max([1], [d for d in other.dims[1] if d != 1])]
    ...
    def __rmul__(self, other):
        ...
        if isinstance(other, Qobj):  # if both are quantum objects
            if (self.shape[1] == other.shape[0] and
                ...
                out.dims = [max([1], [d for d in other.dims[0] if d != 1]),
                            max([1], [d for d in self.dims[1]  if d != 1])]
