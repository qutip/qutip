...
def get_blocks(int N):
    ...
    blocks = np.array([i * (N + 2 - i) for i in range(1, num_blocks + 1)],
                      dtype = int)
    return blocks
...
cdef tuple get_index(int N, double j, double m, double m1,
                         long [:] blocks):
    """
...
cdef class Dicke(object):
    ...
    def __init__(self, int N = 1,
                 float loss = 0., float dephasing = 0., float pumping = 0., float emission = 0., float collective_pumping = 0.,
    ...
    cpdef list lindbladian(self):
        ...
        return [lindblad_row, lindblad_col, lindblad_data]
    ...
    cpdef complex gamma1(self, tuple jmm1):
        ...
        cdef float spontaneous, losses, pump, collective_pump, dephase, collective_dephase, g1
    ...
    cpdef complex gamma2(self, tuple jmm1):
        ...
        cdef float spontaneous, losses, pump, collective_pump, dephase, collective_dephase
