...
def rand_herm(N=None, density=0.75, dims=None, pos_def=False, seed=None):
    ...
    if isinstance(N, (np.ndarray, list)):
        ...
        N = len(N)
        if dims:
            _check_dims(dims, N, N, "Hermitian operator")
        ...
        N, dims = _check_dims(dims, N, N, "Hermitian operator")
        if density < 0.5:
...
def rand_unitary(N=None, density=0.75, dims=None, seed=None):
    ...
    """
    N, dims = _check_dims(dims, N, N, 'unitary operator')
...
def rand_unitary_haar(N=None, dims=None, seed=None):
    ...
    U : Qobj
        ...
        measure.
    """
    N, dims = _check_dims(dims, N, N, 'density operator')
...
def rand_ket(N=None, density=1, dims=None, seed=None):
    ...
    N, dims = _check_dims(dims, N, 1, 'state vector')
...
def rand_dm(N=None, density=0.75, pure=False, dims=None, seed=None):
    ...
    if isinstance(N, (np.ndarray, list)):
        ...
        N = len(N)
        if dims:
            _check_dims(dims, N, N, "density operator")
        nvals = N**2*density
...
def rand_kraus_map(N=None, dims=None, seed=None):
    ...
    """
    N, dims = _check_dims(dims, N, N, 'operator')
...
def rand_stochastic(N=None, density=0.75, kind='left', dims=None, seed=None):
    ...
    """
    N, dims = _check_dims(dims, N, N, 'matrix')
...
def _check_dims(dims, N1, N2, error_type):
    """
