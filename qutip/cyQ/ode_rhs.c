/* Generated by Cython 0.13 on Thu Oct 13 13:19:16 2011 */
...
/* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":36
...
static PyObject *__pyx_pf_7ode_rhs_cyq_ode_rhs_rho(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("cyq_ode_rhs_rho", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__data);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("cyq_ode_rhs_rho", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__idx);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("cyq_ode_rhs_rho", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__ptr);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("cyq_ode_rhs_rho", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "cyq_ode_rhs_rho") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_t = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_t == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_t = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_t == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __Pyx_RaiseArgtupleInvalid("cyq_ode_rhs_rho", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_rho), __pyx_ptype_5numpy_ndarray, 1, "rho", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data), __pyx_ptype_5numpy_ndarray, 1, "data", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_idx), __pyx_ptype_5numpy_ndarray, 1, "idx", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ptr), __pyx_ptype_5numpy_ndarray, 1, "ptr", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_rho, (PyObject*)__pyx_v_rho, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_rho = __pyx_bstruct_rho.strides[0];
  __pyx_bshape_0_rho = __pyx_bstruct_rho.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_data, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo___pyx_t_double_complex, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_data = __pyx_bstruct_data.strides[0];
  __pyx_bshape_0_data = __pyx_bstruct_data.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_idx, (PyObject*)__pyx_v_idx, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_idx = __pyx_bstruct_idx.strides[0];
  __pyx_bshape_0_idx = __pyx_bstruct_idx.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_ptr, (PyObject*)__pyx_v_ptr, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_1 = PyObject_Length(((PyObject *)__pyx_v_rho)); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_t_2 = PyInt_FromLong(__pyx_v_num_rows); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_6 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__complex); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_6 = PyEval_CallObjectWithKeywords(__pyx_t_3, __pyx_t_2, ((PyObject *)__pyx_t_4)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
 ...
 */
    ...
    /* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":46
 *         dot=0.0
 *         row_start = ptr[row]
 *         row_end = ptr[row+1]             # <<<<<<<<<<<<<<
 *         for jj in range(row_start,row_end):
 ...
 */
    ...
    /* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":47
 *         row_start = ptr[row]
 *         row_end = ptr[row+1]
 *         for jj in range(row_start,row_end):             # <<<<<<<<<<<<<<
 *             dot = dot + data[jj]*rho[idx[jj]]
 ...
 */
    ...
    for (__pyx_t_12 = __pyx_v_row_start; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":48
 *         row_end = ptr[row+1]
 *         for jj in range(row_start,row_end):
 *             dot = dot + data[jj]*rho[idx[jj]]             # <<<<<<<<<<<<<<
 *         out[row,0]=dot
 ...
 */
      ...
      __pyx_v_dot = __Pyx_c_sum(__pyx_v_dot, __Pyx_c_prod((*__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_bstruct_data.buf, __pyx_t_13, __pyx_bstride_0_data)), (*__Pyx_BufPtrStrided1d(__pyx_t_double_complex *, __pyx_bstruct_rho.buf, __pyx_t_15, __pyx_bstride_0_rho))));
    }

    /* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":49
 *         for jj in range(row_start,row_end):
 *             dot = dot + data[jj]*rho[idx[jj]]
 *         out[row,0]=dot             # <<<<<<<<<<<<<<
 *     return out
 ...
 */
    ...
    __pyx_t_17 = 0;
    *__Pyx_BufPtrStrided2d(__pyx_t_double_complex *, __pyx_bstruct_out.buf, __pyx_t_16, __pyx_bstride_0_out, __pyx_t_17, __pyx_bstride_1_out) = __pyx_v_dot;
  }

  /* "/home/rob/Desktop/qutip/qutip/qutip/qutip/cyQ/ode_rhs.pyx":50
 *             dot = dot + data[jj]*rho[idx[jj]]
 *         out[row,0]=dot
 *     return out             # <<<<<<<<<<<<<<
 * 
