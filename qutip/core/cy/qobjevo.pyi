...
class QobjEvo:
    ...
    def __sub__(self, other: Union[QobjEvo, Qobj, Number]) -> QobjEvo: ...
    def __isub__(self, other: Union[QobjEvo, Qobj, Number]) -> QobjEvo: ...
    def __rsub__(self, other: Union[QobjEvo, Qobj, Number]) -> QobjEvo: ...
    def __and__(self, other: Union[Number, Qobj]) -> QobjEvo: ...
    def __rand__(self, other: Union[Number, Qobj]) -> QobjEvo: ...
    def __call__(self, t: Number, **new_args) -> Qobj: ...
    def __matmul__(self, other: Union[QobjEvo, Qobj]) -> QobjEvo: ...
    def __imatmul__(self, other: Union[QobjEvo, Qobj]) -> QobjEvo: ...
    def __rmatmul__(self, other: Union[QobjEvo, Qobj]) -> QobjEvo: ...
    def __mul__(self, other: Union[Number, Coefficient]) -> QobjEvo: ...
    def __imul__(self, other: Union[Number, Coefficient]) -> QobjEvo: ...
    def __rmul__(self, other: Union[Number, Coefficient]) -> QobjEvo: ...
