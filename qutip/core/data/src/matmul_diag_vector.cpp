...
#else
            out_dbl[ptr] += scale_dbl[0] * (data_dbl[ptr] * vec_dbl[2*i] - data_dbl[ptr+1] * vec_dbl[2*i+1])
                          - scale_dbl[1] * (data_dbl[ptr] * vec_dbl[2*i+1] + data_dbl[ptr+1] * vec_dbl[2*i]);
            out_dbl[ptr+1] += scale_dbl[0] * (data_dbl[ptr] * vec_dbl[2*i+1] + data_dbl[ptr+1] * vec_dbl[2*i])
                            + scale_dbl[1] * (data_dbl[ptr] * vec_dbl[2*i] - data_dbl[ptr+1] * vec_dbl[2*i+1]);
#endif
            ptr+=2;
        }
    }
