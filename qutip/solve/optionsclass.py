"""
Temporary implementation for qutip options used when migrating from v4, to v5.
Will be removed before v5 release.
"""
...
dummyParent._defaultInstance = dummyParent()


def optionsclass(name, parent=dummyParent):
    """
