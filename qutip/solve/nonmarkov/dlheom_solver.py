...
"""
This code is still in v4 format
"""
...
from qutip.core.states import enr_state_dictionaries
...
class HEOMSolver(object):
    ...
    def configure(self, H_sys, coup_op, coup_strength, temperature,
        ...
        if isinstance(options, SolverOptions): self.options = options
