...
def coherent(N, alpha, method='displacement'):
    ...
    method : string 
        Select method 'displacement' (default) or 'analytic'. With the 
        'displacement' method the coherent state is generated by displacing
        the vacuum state using the displacement operators. This method 
        guarantees that the resulting state is normalized. With 'analytic'
        method the coherent state is generated using the analytical formula
        for the coherent state coefficients in the Fock basis. This method does
        not guarantee that the state is normalized if truncated to a small
        number of Fock states, but would in that case give more accurate 
        coefficients.
...
def coherent_dm(N, alpha, method='displacement'):
