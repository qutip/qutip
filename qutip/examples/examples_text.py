...
# (0=quit in commandline)
basic_nums = 10 + arange(len(basic_labels))

# master equation demos
master_labels = ["i-Swap Gate",
...
advanced_labels = ["Nonadiabtic evolution",
                   "Lindblad vs. Redfield",
                   "LZS inteferometry",
                   "QPT"]
...
button_labels = [basic_labels, master_labels, monte_labels, td_labels,
                 advanced_labels]
...
qutip_keywords = [
    "basis", "Bloch", "brmesolve", "concurrence", "create", "destroy",
    "displace", "entropy_linear", "entropy_mutual", "entropy_vn", "expect",
    "fidelity", "ket2dm", "parfor", "qeye", "qfunc", "Qobj", "rand_dm",
    "rand_herm", "rand_ket", "rand_unitary", "squeez", "tensor",
    "tracedist", "wigner"]
