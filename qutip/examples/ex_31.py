#
# Occupation number of two coupled osciilators with oscillator A driven by an
# external classical drive. Both oscillators are assumed to start in the ground
# state.
#
from qutip import *
from pylab import *
