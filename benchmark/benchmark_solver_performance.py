...
# save benchmark data
# 
times_mat = append(matrix(Na_vec * Nb).T, times, axis=1)
file_data_store("benchmark-solver-performance-unitary-nruns-%d.dat" % (n_runs), times_mat, "real")
...
legend(solvers)
savefig("benchmark-solver-performance-unitary-nruns-%d.pdf" % (n_runs))
...
# 
times_mat = append(matrix(Na_vec * Nb).T, times, axis=1)
file_data_store("benchmark-solver-performance-dissipative-nruns-%d.dat" % (n_runs), times_mat, "real")
...
legend(solvers)
savefig("benchmark-solver-performance-dissipative-nruns-%d.pdf" % (n_runs))
