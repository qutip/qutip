# -*- coding: utf-8 -*-
"""
Created on Fri May 19 19:05:50 2023
...
for idz, E2P in enumerate(P_array):
    ...
    low_op =  mat(1,1)                                #lowering operator that acts on the excited state to bring it to the ground state
...
testg1 = correlation.correlation_2op_2t_floquet(H,
                                        rhossF,
                                        np.round(tlist,6),
                                        None,
                                        np.round(taulist2,6),
