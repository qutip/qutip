...
.. figure:: http://qutip.googlecode.com/svn/wiki/images/examples-lasing-occupations.png
    :align: center
    
    Cavity and atom occupation probabilities.
    
.. figure:: http://qutip.googlecode.com/svn/wiki/images/examples-lasing-distribution.png
    :align: center

    Cavity photon distribution (final state).
    
.. figure:: http://qutip.googlecode.com/svn/wiki/images/examples-lasing-wigner.png
    :align: center
