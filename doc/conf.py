...
# built documents.
qutip_root = pathlib.Path(__file__).absolute().parent.parent
qutip_release = qutip_root.joinpath("VERSION").read_text().strip()
# The short X.Y version.
version = ".".join(qutip_release.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = qutip_release
