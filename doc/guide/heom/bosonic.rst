...
.. admonition:: Environment API
    ...
    .. plot::
        ...
        # Matsubara expansion:
        approx, _ = env.approx_by_matsubara(Nk)

        # Padé expansion:
        approx, _ = env.approx_by_pade(Nk)
...
.. admonition:: Environment API
    ...
    Here, the terminator amplitude is returned directly by the ``approx_by_matsubara`` and ``approx_by_pade`` methods used earlier.
    ...
    .. plot::
        ...
        # Matsubara expansion:
        approx, delta = env.approx_by_matsubara(Nk)

        # Padé expansion:
        approx, delta = env.approx_by_pade(Nk)
